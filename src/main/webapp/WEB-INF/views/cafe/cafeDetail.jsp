...
<nav class="flex justify-center space-x-4 mb-4">
  <button id="btn-info" class="tab-btn px-4 py-2 rounded bg-blue-600 text-white">상세정보</button>
  <button id="btn-review" class="tab-btn px-4 py-2 rounded bg-gray-200 hover:bg-gray-300">리뷰</button>
  <button id="btn-qna" class="tab-btn px-4 py-2 rounded bg-gray-200 hover:bg-gray-300">Q&A</button>
</nav>
...
<script>
  $(document).ready(function () {
    $(".seat-box").click(function () {
      ...
      $(".seat-box").removeClass("bg-green-500 text-white");
