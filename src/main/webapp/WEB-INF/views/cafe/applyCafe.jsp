...
<jsp:include page="/WEB-INF/views/common/header.jsp"></jsp:include>
	...
	<form action= "/ApplyCafeServlet" method="post">
		...
		<div class="input-wrap">
			...
			<div>
				<input type="text" id="cafeAddr" name="cafeAddr" >
			</div>
			<p id="addrMsg"></p>
		</div>
		...
		<div class="input-wrap">
			...
			<div>
				<input type="text" id="cafePhone" name="cafePhone" placeholder="010-0000-0000형식" maxlength="13">
			</div>
			<p id="phoneMsg"></p>
		</div>
		...
		<div class="input-wrap">
			...
			<div>
				<input type="text" id="cafeBiznum" name="cafeBiznum" placeholder="000-00-00000형식" maxlength="12">
			</div>
			<p id="biznumMsg"></p>
		</div>
		...
		<div class="input-wrap">
			...
			<div>
				<input type="text" id="cafeIntroduce" name="cafeIntroduce" placeholder="최대 한글160자">
			</div>
		</div>
		...
		<div class="input-wrap">
			...
			<div>
				<input type="text" id="cafeIntroDetail" name="cafeIntroDetail" placeholder="최대 한글160자" >
			</div>
		</div>
		...
		<div class="input-wrap">
			...
			<div>
				<input type="text" id="cafeStartHour" name="cafeStartHour" placeholder="00:00 형식" maxlength="5">
			</div>
			<p id="startHourMsg"></p>
		</div>
		...
		<div class="input-wrap">
			...
			<div>
				<input type="text" id="cafeEndHour" name="cafeEndHour" placeholder="00:00 형식" maxlength="5">
			</div>
			<p id="endHourMsg"></p>
		</div>
